               ...
               <div className='logo'></div>
                ...
                <div className="form-box">
                    <div className="form-item">
                        ...
                        <input type="text" onChange={changePhone} value={formData.account} placeholder="请输入账号"/>
                    </div>
                    <div className="form-item">
                        <div className="form-item-title">密码</div>
                        <input type="text" onChange={changeCode} value={formData.password} placeholder="请输入密码"/>
